...
IGNORE_PREFIX = "tag/"
WILDCARD_TRIGGER = "tag/root/index.html"
WILDCARD_VAL = "/tag/*"
...
def handle_s3_change(event, context):
    ...
    Found here on Monday, 31 May 2021

    https://github.com/igor-kupczynski/terraform_static_aws_website/blob/master/invalidate_cloud_front.py   
